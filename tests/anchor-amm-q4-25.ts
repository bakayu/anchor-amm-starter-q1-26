...
describe("anchor-amm-q4-25", () => {
    ...
    before(async () => {
        ...
        mintX = await createMint(connection, provider.wallet.payer, authority, null, 6);
        mintY = await createMint(connection, provider.wallet.payer, authority, null, 6);
        ...
        await mintTo(connection, provider.wallet.payer, mintX, userX, provider.wallet.payer, 1_000);
        await mintTo(connection, provider.wallet.payer, mintY, userY, provider.wallet.payer, 1_000);
    });
